<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Data Sekolah</span>
        </li>
        ...
        {{-- Data Guru --}}
        <li class="menu-item {{ request()->is('admin/guru*') && !request()->is('admin/guru-mapel*') ? 'active' : '' }}">
            <a href="{{ route('guru.admin.index') }}" class="menu-link">
        ...
        {{-- Guru Mapel --}}
        <li class="menu-item {{ request()->is('admin/guru-mapel*') ? 'active' : '' }}">
            <a href="{{ route('guru-mapel.index') }}" class="menu-link">
        ...
        {{-- Tahun Ajar --}}
        <li class="menu-item {{ request()->is('admin/tahun-ajar*') ? 'active' : '' }}">
            <a href="{{ route('tahun-ajar.index') }}" class="menu-link">
        ...
        {{-- Anggota Kelas --}}
        <li class="menu-item {{ request()->is('admin/anggota-kelas*') ? 'active' : '' }}">
            <a href="{{ route('anggota-kelas.index') }}" class="menu-link">
        ...
        <li class="menu-item {{ request()->is('admin/assessment-categories*') ? 'active' : '' }}">
        ...
        {{-- ===== SECTION: POIN & REWARD ===== --}}
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">Poin & Reward</span>
        </li>

        {{-- Point Rules --}}
        <li class="menu-item {{ request()->is('admin/point-rules*') ? 'active' : '' }}">
        ...
        {{-- Flexibility Items --}}
        <li class="menu-item {{ request()->is('admin/flexibility-items*') ? 'active' : '' }}">
            <a href="{{ route('flexibility-items.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-store-alt"></i>
                <div>Item Penukaran</div>
            </a>
        </li>
        ...
        <li class="menu-item">
            <form action="{{ route('logout') }}" method="POST" class="w-100">
                @csrf
                <button type="submit" class="menu-link text-danger w-100 border-0 bg-transparent text-start"
